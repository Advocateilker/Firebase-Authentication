...
import { update, resetPassword, auth } from "../firebase/config";
...
export default function UpdateProfile() {
  ...
  return (
    <div className="profile w-[50%] my-0 mx-auto text-center grid gap-y-10">
      <form onSubmit={handleSubmit} className="grid gap-y-4">
        <h1 className="text-xl font-bold text-white mb-4">Update Profile</h1>
        <div>
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              type="password"
              placeholder="*****"
              className="shadow-sm px-2 py-1 focus:ring-indigo-500 focus:border-indigo-500 mt-3 block w-full sm:text-sm border-gray-300 rounded-md"
              value={password}
